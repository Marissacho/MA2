/*
Inserting the randomly generated integers into a BST generally gives a height in
the order of:
Your answer:O(log n)
*/
...
bst->printLevels();
cout << "(1.3) Is 100 in BST? true (1) or false (0): " << bst->contains(100) <<
endl;
cout << "(1.4) Is 9 in BST? true (1) or false (0): " << bst->contains(9) <<
endl;
